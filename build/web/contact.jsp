...
<div id ="content">
    ...
    <div style="background-color:#0E0702;color:white;font-size:15px;height:180px;text-align:center;margin-top:20px;padding-top:55px; ">
    <%
                    ...
                    try {
                        ...
                        String query = "INSERT INTO feedback (firstname,lastname,email,contact_no,message) VALUES ('"+fname+"', '"+lname+"', '"+email+"', '"+contact+"', '"+message+"')";
                        int n = stmt.executeUpdate(query);
                        if (n!=0){
                            out.println("<h4>Feedback is successfully recorded ... Now you can view your   <a href='feedback.jsp'>Feedback</a></h4>");
                        }else{
                            out.println("<h4>Error while submitting the response.</h4>");
                        }
