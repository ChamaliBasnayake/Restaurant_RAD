<%-- 
    Document   : ordering
    Created on : Nov 29, 2018, 2:38:48 PM
    Author     : ASUS-PC
--%>
...
<img src="Images/Online_food/logo.jpg" style="height:90px;width:300px;border: 2px solid;border-radius: 5px;"><br>
            ...
            <div id="adbox">
                <%
                    ...
                    try {
                        ...
                        String query = "INSERT INTO customer_details (email,phone,psw,item,quantity,siz) VALUES ('"+email+"', '"+phone+"', '"+psw+"','"+item+"', '"+quantity+"', '"+siz+"')";
                        int n = stmt.executeUpdate(query);
                        if (n!=0){
                            out.println("<h4>You ordered Successfully... <br> Please wait patiently!!! <br>You will get a call!! </h4> <h2> THANK YOU!!</h2> <a href='foodlist.html'>Take another order!!</a>");
                        }else{
                            out.println("<h4>Error while entering the details.</h4>");
                        }
...
Sri Lanka <br>T: +94112161161<br> F: +94 11 2320862</p><p style="color:white;margin-left:14px;font-size:13px">E-mail:&nbsp;<a href="mailto:info@uwu.ac.lk">ramsayrestaurants@gmail.com</a></p>
          ...
          <div style="margin-left:850px">
				<p style="margin-top:-180px;align:right">
						...
						<a href="https://facebook.com/ramsay"><img src="Images/Online_food/fb.jpg"></a>
						
						<a href="https://www.twitter.com/ramsay"><img src="Images/Online_food/twi.jpg"></a>
					
						<a href="https://www.youtube.com/ramsay"><img src="Images/Online_food/you.png"></a>
					
						<a href="https://instagram.com/gordongram/"><img src="Images/Online_food/ins.jpg"></a>
					
						<a href="https://plus.google.com/109425930484960903187/posts"><img src="Images/Online_food/go.png"></a>
			   </p>			
		  </div>
