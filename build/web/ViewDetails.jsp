...
<% String id = request.getParameter("Id");
    ...
    ResultSet resultSet = null; %> <!DOCTYPE html> <html> <body>  
        <center> <h1 style="color:white;">Table Reserve Details</h1><br></center> <br> 
        ...
        <tr> <td><%=resultSet.getString("fname")%></td>
            ...
            <td><%=resultSet.getString("meals")%></td>
            <td><%=resultSet.getString("tableType")%></td>
            </tr> <% }
        connection.close();
    } catch (Exception e) {
        e.printStackTrace();
